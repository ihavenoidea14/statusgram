...
router.post('/', function(req, res) {
  ...
  */
  ...
  doc.image('./img/statusgramlistagent.png', 0, 0, { scale: 0.721 });
  ...
  */
  ...
  doc.fontSize(12).fillColor('#004990')
    .text(`Hi ${req.body.listagent}, it's our pleasure to finance the purchase of ${req.body.propfull} with ${req.body.morttype}.`, 43, 132);
  ...
  */
  ...
  doc.fontSize(8).fillColor('#004990')
    .text(req.body.listagentnotes, 25, 439, { width: 370, align: 'left'});
